         ...
         <div class="iq-sidebar">
            ...
            <div id="sidebar-scrollbar">
               ...
               <ul id="iq-sidebar-toggle" class="iq-menu">                    
                     <li>
                        <a href="dashboard-1.html" class="iq-waves-effect"><i class="ri-home-8-fill"></i><span>BQ</span></a>
                     </li>
                     <li>
                        <a href="dashboard-1.html" class="iq-waves-effect"><i class="ri-home-8-fill"></i><span>Surat Penerimaan </span></a>
                     </li>
                     <li>
                        <a href="dashboard-1.html" class="iq-waves-effect"><i class="ri-home-8-fill"></i><span>Invoice</span></a>
                     </li>
                     <li>
                        <a href="dashboard-1.html" class="iq-waves-effect"><i class="ri-home-8-fill"></i><span>Input Surat Laporan</span></a>
                     </li>
                     <li>
                        <a href="dashboard-1.html" class="iq-waves-effect"><i class="ri-home-8-fill"></i><span>Tender Selesai</span></a>
                     </li>
                     <li>
                        <a href="dashboard-1.html" class="iq-waves-effect"><i class="ri-home-8-fill"></i><span>Progress Tender </span></a>
                     </li>
                  </ul>
               </nav>
               <div class="p-3"></div>
      ...
      <script>
          ...
          $('document').ready(function(){
            ...
            $('#Tambah').click(function(){
                ...
                var lain2_param = {
                    nama : $('#nama_lain2').val(),
                    nominal: $('#nominal_lain2').val(),
                    jumlah : $('#jumlah_lain2').val(),
                }
